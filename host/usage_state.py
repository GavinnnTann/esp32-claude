...
# Little-endian: uint8, uint32 x10, uint8 x3, char[16], char[8] = 68 bytes.
...
MODEL_LEN = 16
EFFORT_LEN = 8
_U32_FIELDS = 10  # ts, day_tokens, day_cents, week_*, block_*, *_reset, limits_fetched
...
assert STRUCT_SIZE == 68, f"struct is {STRUCT_SIZE} bytes, firmware expects 68"
