 ...
 * NOTE: sizes actually used by this project (10, 24) are enabled via
 * `build_flags` in platformio.ini instead of here, so they survive even if
 * this file gets regenerated/overwritten by a future SquareLine export. */
...
#define LV_USE_TFT_ESPI         0 /* Not used: main.cpp owns a single TFT_eSPI instance directly so touch (getTouch) can share it */
